 ...
 */
  .controller("RequestsController", [
    ...
    "$filter",
    "Request",
    function($scope, $translatePartialLoader, $translate, $filter, Request) {
      $scope.query = null;
      $scope.requests = [];
      $scope.facets = [];
      $scope.filters = {};
     ...
     */
      $scope.isSelectedFilter = function(facet, value) {
        return !($scope.filters[facet] == undefined ||
          $scope.filters[facet].indexOf(value) == -1);
      };
