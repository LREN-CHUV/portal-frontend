  ...
  .factory('ChartUtil', [function () {
    ...
    return function (config, dataset) {
      ...
      if (!config.xAxisVariable) {
        config.xAxisVariable = dataset.header[0];
      }
...
//          idx1, idx2, data;
//
//        for (idx1 = 0; idx1 < dataset.header.length; idx1++) {
//          data = dataset.data[dataset.header[idx1]];
//          for (idx2 = 0; idx2 < data.length; idx2++) {
//            result.push([idx1, idx2, data[idx2]]);
//          }
//        }
...
//      } else if (chartConfig.options.chart.type === "heatmap") {
//        buildDesignMatrix(chartConfig,dataset);
//      } else {
...
//     * @param dataset
//     */
//    buildBoxplotChart: buildBoxplotChart,
//    /**
//     * build design matrix
//     * @param chartConfig
//     * @param dataset
...
//     * @param dataset
//     */
//    buildStandardChart: buildStandardChart
//  }
//}]);
