// this is a fork of http://angular-dragdrop.github.io/angular-dragdrop/ to better suit my needs.
...
(function(angular) {
  ...
  if (
    window.jQuery && -1 === window.jQuery.event.props.indexOf("dataTransfer")
  ) {
    ...
    function($parse, $rootScope, $dragImage) {
      return function(scope, element, attrs) {
        ...
        function dragstartHandler(e) {
          var isDragAllowed =
            !isDragHandleUsed || dragTarget.classList.contains(dragHandleClass);
          ...
          if (isDragAllowed) {
              ...
              scope.$apply(function() {
                ...
                if (dragImageParameters) {
                  if (angular.isString(dragImageParameters)) {
                    dragImageParameters = $dragImage.generate(
                      dragImageParameters
                    );
                  }
            ...
            e.dataTransfer.setData("text/html", dragData);
            e.dataTransfer.effectAllowed = "copyMove";
  ...
  module.directive("uiOnDrop", [
    ...
    function($parse, $rootScope) {
      return function(scope, element, attr) {
        ...
        var deregisterDragStart = $rootScope.$on("ANGULAR_DRAG_START", function(
          _,
          e,
          channel,
          transferDataObject
