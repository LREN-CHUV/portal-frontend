...
!(function(a) {
  ...
  function c(a) {
    ...
    return /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) &&
      (f = 0), { top: b.top + d.pageYOffset - e.clientTop, left: b.left + f - e.clientLeft };
  }
  function d(a) {
  ...
  function r(a, b, c) {
    ...
    return (d =
      a[
        h - 1
      ]), (e = a[h]), (f = b[h - 1]), (g = b[h]), f + o([d, e], c) / m(f, g);
  }
  function s(a, b, c) {
    ...
    return (d =
      a[
        h - 1
      ]), (e = a[h]), (f = b[h - 1]), (g = b[h]), p([d, e], (c - f) * m(f, g));
  }
  function t(a, c, d, e) {
    if (100 === e) return e;
    var f, g, h = q(e, a);
    return d
      ...
      : c[h - 1] ? a[h - 1] + b(e - a[h - 1], c[h - 1]) : e;
  }
  function u(a, b, c) {
    var e;
    if (
      ("number" == typeof b && (b = [b]), "[object Array]" !==
        Object.prototype.toString.call(b))
    )
      throw new Error("noUiSlider: 'range' contains invalid value.");
    if (
      ((e = "min" === a ? 0 : "max" === a ? 100 : parseFloat(a)), !d(e) ||
        !d(b[0]))
    )
      throw new Error("noUiSlider: 'range' value isn't numeric.");
    c.xPct.push(
      e
    ), c.xVal.push(b[0]), e ? c.xSteps.push(isNaN(b[1]) ? !1 : b[1]) : isNaN(b[1]) || (c.xSteps[0] = b[1]);
  }
  function v(a, b, c) {
    return b
      ? void (c.xSteps[a] =
  ...
  function w(a, b, c, d) {
    (this.xPct = [
    ]), (this.xVal = []), (this.xSteps = [d || !1]), (this.xNumSteps = [!1]), (this.snap = b), (this.direction = c);
    var e, f = [];
  ...
  function L(a) {
    ...
    var b,
      ...
      g = a;
    return 0 === a.type.indexOf("MSPointer") &&
      (f = !0), d && ((b = a.changedTouches[0].pageX), (c = a.changedTouches[0].pageY)), (e || f) && ((b = a.clientX + window.pageXOffset), (c = a.clientY + window.pageYOffset)), (g.points = [b, c]), (g.cursor = e || f), g;
  }
  function M(a, b) {
    var c = document.createElement("div"),
      ...
      e = ["-lower", "-upper"];
    return a &&
      e.reverse(), j(d, T[3]), j(d, T[3] + e[b]), j(c, T[2]), c.appendChild(d), c;
  }
  function N(a, b, c) {
    switch (a) {
      case 1:
  ...
  function Q(b, d) {
    ...
    function m(b, c, d) {
      ...
      return (M.direction = 0), (d = a(
        ...
        (d.unshift(
          g
        ), (i = !0)), d[d.length - 1] !== h && (d.push(h), (j = !0)), d.forEach(
        function(a, e) {
          var g, h, l, m, n, o, p, q, r, s, t = a, u = d[e + 1];
          if (
            ("steps" === c && (g = M.xNumSteps[e]), g || (g = u - t), t !==
              !1 && void 0 !== u)
          )
            for (h = t; u >= h; h += g) {
              for (
                (m = M.toStepping(h)), (n = m - k), (q =
                  n / b), (r = Math.round(q)), (s = n / r), (l = 1);
                r >= l;
                l += 1
              )
                (o = k + l * s), (f[o.toFixed(5)] = ["x", 0]);
              (p = d.indexOf(h) > -1 ? 1 : "steps" === c ? 2 : 0), !e &&
                i &&
                (p = 0), (h === u && j) || (f[m.toFixed(5)] = [h, p]), (k = m);
            }
        }
      ), (M.direction = e), f;
    }
    function n(a, b, c) {
      ...
      function g(a, d) {
        M.direction &&
          (a =
            100 -
            a), (d[1] = d[1] && b ? b(d[0], d[1]) : d[1]), (i.innerHTML += "<div " + f(a, "noUi-marker", d) + "></div>"), d[1] && (i.innerHTML += "<div " + f(a, "noUi-value", d) + ">" + c.to(d[0]) + "</div>");
      }
      var h = ["horizontal", "vertical"][d.ort],
        i = document.createElement("div");
      return j(i, "noUi-pips"), j(i, "noUi-pips-" + h), Object.keys(
        a
      ).forEach(function(b) {
        g(b, a[b]);
      }), i;
    ...
    function q(a, b) {
      void 0 !== b && (b = Math.abs(b - d.dir)), Object.keys(
        R
      ).forEach(function(c) {
        var d = c.split(".")[0];
        a === d &&
    ...
    function t(a, b) {
      var c,
        ...
        h = e[0] === H[0] ? 0 : 1;
      if (
        ((c = K(g, b.positions, e.length > 1)), (f = y(
          e[0],
          c[h],
          1 === e.length
        )), e.length > 1)
    ...
    function v(a, b) {
      ...
      if (
        1 === b.handles.length &&
        (j(b.handles[0].children[0], T[15]), b.handles[0].hasAttribute(
          "disabled"
        ))
      )
        return !1;
      ...
      if (((c.noUiListeners = d.concat(e)), a.cursor)) {
        (document.body.style.cursor = getComputedStyle(
          a.target
        ).cursor), H.length > 1 && j(I, T[12]);
        var f = function() {
          return !1;
        };
        (document.body.noUiListener = f), document.body.addEventListener(
          "selectstart",
          f,
          !1
        );
    ...
    function w(a) {
      ...
      return a.stopPropagation(), H.forEach(function(a) {
        ...
        ? 0
        : 1), (g -= c(G)[d.style]), (e = 100 * g / p()), d.events.snap || f(I, T[14], 300), H[b].hasAttribute("disabled") ? !1 : (y(H[b], e), q("slide", b), q("set", b), q("change", b), void (d.events.snap && v(a, { handles: [H[h]] })));
    }
    function x(a) {
      var b, c;
      if (!a.fixed)
      ...
      a.tap && s(S.start, G, w, { handles: H }), a.drag &&
        ((c = [G.getElementsByClassName(T[7])[0]]), j(c[0], T[10]), a.fixed &&
          c.push(H[c[0] === H[0] ? 1 : 0].children[0]), c.forEach(function(a) {
      ...
      return H.length > 1 &&
        (b = e
          ...
          : Math.min(
              b,
              h
            )), c !== !1 && d.limit && H.length > 1 && (b = e ? Math.min(b, i) : Math.max(b, l)), (b = M.getStep(b)), (b = g(parseFloat(b.toFixed(7)))), b === J[e] ? !1 : ((a.style[d.style] = b + "%"), a.previousSibling || (k(a, T[17]), b > 50 && j(a, T[17])), (J[e] = b), (Q[e] = M.fromStepping(b)), q("update", e), !0);
    }
    function z(a, b) {
      var c, e, f;
      for (
    ...
    function A(a) {
      var b, c, e = h(a);
      for (
        d.dir && d.handles > 1 && e.reverse(), d.animate &&
          -1 !== J[0] &&
          f(I, T[14], 300), (b = H.length > 1 ? 3 : 1), 1 === e.length &&
          (b = 1), z(b, e), (c = 0);
        c < H.length;
        c++
      ) q("set", c);
    ...
    function E(a, b) {
      (R[a] = R[a] || []), R[a].push(b), "update" === a.split(".")[0] &&
    ...
    return (G = P(
      ...
      d.ort,
      I
    )), (H = O(d.handles, d.dir, G)), N(d.connect, I, H), x(d.events), d.pips && o(d.pips), { destroy: C, steps: D, on: E, off: F, get: B, set: A };
  }
  function R(a, b) {
    if (!a.nodeName)
  ...
  (w.prototype.getMargin = function(a) {
    ...
    return this.direction && (a = 100 - a), (a = t(
      this.xPct,
      this.xSteps,
      this.snap,
      a
