...
!(function(a, b) {
  ...
  (r.event = {
    ...
    add: function(a, b, c, d, e) {
      ...
      if (q) {
        c.handler && ((f = c), (c = f.handler), (e = f.selector)), e &&
          r.find.matchesSelector(qa, e), c.guid || (c.guid = r.guid++), (i =
    ...
    off: function(a, b, c) {
      ...
      return (b !== !1 && "function" != typeof b) ||
        ((c = b), (b = void 0)), c === !1 && (c = va), this.each(function() {
  ...
  function Xa(a, b, c) {
    ...
    if (
      ...
      if (
        ((d = Na(a, b, f)), (d < 0 || null == d) && (d = a.style[b]), La.test(
          d
        ))
      )
        return d;
  ...
  r.extend({
    ...
    css: function(a, b, c, d) {
      ...
      return (b = r.cssProps[h] || (r.cssProps[h] = Ua(h) || h)), (g =
        ...
        "get" in g &&
        (e = g.get(a, !0, c)), void 0 === e && (e = Na(a, b, d)), "normal" ===
        e &&
        b in Ra &&
        (e = Ra[b]), "" === c || c
    ...
    if (((i = !r.isEmptyObject(b)), i || !r.isEmptyObject(n))) {
      l &&
        ...
        ((c.overflow = [o.overflow, o.overflowX, o.overflowY]), (j =
          q && q.display), null == j && (j = V.get(a, "display")), (k = r.css(
          a,
          "display"
        )), "none" === k &&
          (j
  ...
  (r.Animation = r.extend(hb, {
    ...
    tweener: function(a, b) {
      ...
      for (var c, d = 0, e = a.length; d < e; d++)
        (c = a[d]), (hb.tweeners[c] = hb.tweeners[c] || []), hb.tweeners[
          c
        ].unshift(b);
    },
    prefilters: [fb],
  ...
  r.fn.extend({
    ...
    jb[b] = function(a, b, d) {
      ...
      return d ||
        ((f = jb[g]), (jb[g] = e), (e = null != c(a, b, d) ? g : null), (jb[
          g
        ] = f)), e;
    };
  });
    ...
    ajax: function(b, c) {
      ...
      (l = r.event && o.global), l &&
        ...
        : ((n = o.url.slice(f.length)), o.data &&
            ((f +=
              (sb.test(f) ? "&" : "?") + o.data), delete o.data), o.cache ===
            !1 &&
            ((f = f.replace(Ab, "$1")), (n =
  ...
  (o.cors =
    !!Pb &&
    "withCredentials" in Pb), (o.ajax = Pb = !!Pb), r.ajaxTransport(function(
    b
  ) {
    var c, d;
  ...
  r.ajaxSetup({
    ...
    if (h || "jsonp" === b.dataTypes[0])
      return (e = b.jsonpCallback = r.isFunction(b.jsonpCallback)
        ...
        : b.jsonp !== !1 &&
            (b.url +=
              (sb.test(b.url) ? "&" : "?") + b.jsonp + "=" + e), (b.converters[
        "script json"
      ] = function() {
