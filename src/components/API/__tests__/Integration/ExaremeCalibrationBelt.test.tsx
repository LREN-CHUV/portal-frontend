...
const parameters = [
  {
    name: 'e',
    label: 'e',
    value: 'probGiViTI_2017_Complessiva'
  },
  {
    name: 'o',
    label: 'o',
    value: 'hospOutcomeLatest_RIC10'
  },
  {
    name: 'devel',
    label: 'devel',
...
const model: any = (datasets: VariableEntity[]) => ({
  query: {
    ...
    coVariables: [
      {
        code: 'rightententorhinalarea_logreg_test'
      }
    ],
    filters: '',
    groupings: [],
    ...
    variables: [
      {
        code: 'righthippocampus_logreg_test'
      }
    ]
  }
});
...
describe('Integration Test for experiment API', () => {
  let datasets: VariableEntity[] | undefined = [{ code: 'cb_data' }];
