  ...
  groups: [
    {
      ...
      groups: [
          ...
          variables: [
            {
              code: 'fdg',
              description:
                ' Average FDG-PET of angular, temporal, and posterior cingulate. Most important hypometabolic regions that are indicative of pathological metabolic change in MCI and AD.',
              label: 'FDG-PET',
              methodology: 'adni-merge',
              type: 'real'
            },
            {
              code: 'pib',
              description:
                'Average PIB SUVR of frontal cortex, anterior cingulate, precuneus cortex, and parietal cortex.',
              label: 'PIB',
              methodology: 'adni-merge',
              type: 'real'
            },
            {
              code: 'av45',
              description:
                'AV45 Average AV45 SUVR of frontal, anterior cingulate, precuneus, and parietal cortex relative to the cerebellum',
              label: 'AV45',
              methodology: 'adni-merge',
              type: 'real'
            }
        ...
        },
        {
          code: 'proteome',
          description:
            'Protein biology as detected using routine lab chemistries in blood and cerebrospinal fluid specimens as well as in biopsy, measurement of protein-protein interactions, level of antibodies, auto-antibodies, etc.',
          groups: [
            {
              code: 'csf_proteome',
              ...
              variables: [
                {
                  ...
                  label:
                    'Level of amyloid beta 1-42 peptides in cerebrospinal fluid',
                  methodology: 'mip-cde',
                  type: 'real',
                  units: ''
                },
                {
                  ...
                  description:
                    "A\u03b2 is the main component of amyloid plaques (extracellular deposits found in the brains of patients with Alzheimer''s disease). Similar plaques appear in some variants of Lewy body dementia and in inclusion body myositis (a muscle disease), while A\u03b2 can also form the aggregates that coat cerebral blood vessels in cerebral amyloid angiopathy. The plaques are composed of a tangle of regularly ordered fibrillar aggregates called amyloid fibers, a protein fold shared by other peptides such as the prions associated with protein misfolding diseases.",
                  label:
                    'Level od amyloid beta 1-40 peptides ion cerebrospinal fluid',
                  methodology: 'mip-cde',
                  type: 'real',
                  units: ''
                },
                ...
                },
                {
                  ...
                  label:
                    'Level of phosphorylated tau proteins in cerebrospinal fluid ',
                  methodology: 'mip-cde',
                  type: 'real',
                  units: ''
                }
          ...
          label:
            "Entire set of proteins expressed by the patient''s organism at the time of the medical workup"
        },
        {
          code: 'brain_anatomy',
          groups: [
        ...
        },
        {
          ...
          variables: [
            ...
            },
            {
              code: 'subjectage',
              description:
                'Exact age of the subject, for datasets that allow such precision.',
              label: 'Exact age',
              length: 2,
              maxValue: 11,
              methodology: 'mip-cde',
            ...
            },
            {
              code: 'handedness',
              description:
                'Describes the tendency of the patient to use either the right or the left hand more naturally than the other.',
              enumerations: [
                {
                  code: 'R',
                  label: 'Right'
          ...
          groups: [
            {
              ...
              variables: [
                ...
                },
                {
                  code: 'updrshy',
                  description:
                    "The Hoehn and Yahr scale (HY) is a widely used clinical rating scale, which defines broad categories of motor function in Parkinson''s disease (PD). It captures typical patterns of progressive motor impairment.",
          ...
          variables: [
            {
              ...
              description:
                'The Mini-Mental State Examination (MMSE) or Folstein test is a 30-point questionnaire that is used extensively in clinical and research settings to measure cognitive impairment. It is commonly used to screen for dementia.',
        ...
        },
        {
              ...
              variables: [
                {
                  code: 'adnicategory',
                  description:
                    'Terms aggregating illnesses into classes. Note that the diagnosis in this categories are given only for the ADNI data set.',
                  enumerations: [
                    {
                      code: 'AD',
                ...
                },
                {
                  code: 'edsdcategory',
                  description:
                    'Terms aggregating illnesses into classes. Note that the diagnosis in this categories are given only for the EDSD data set.',
                  enumerations: [
                    {
                      code: 'AD',
                      label: "Alzheimer''s Disease"
                ...
                },
                {
                  code: 'ppmicategory',
                  description:
                    "Terms aggregating the Parkinson''s diseases into classes. For this instance the diagnosis given at enrollment is taken as the clinical diagnosis. Note that the diagnosis in this categories are given only for the PPMI data set.",
                  enumerations: [
                    {
                      code: 'PD',
                    ...
                    },
                    {
                      code: 'GENPD',
                      label:
                        'Genetic PD patients with a mutation (LRRK2, GBA or SNCA)'
                    },
                    {
                      code: 'REGUN',
                      label:
                        'Genetic Unaffected patients with a mutation (LRRK2, GBA or SNCA)'
                    },
                    {
                      code: 'REGPD',
                      label:
                        'Genetic registry PD subjects with a mutation (LRRK2, GBA, or SNCA)'
                    },
                    {
                      code: 'REGUN',
                      label:
                        'Genetic registry unaffected subjects with a mutation (LRRK2, GBA, or SNCA)'
                    }
                  ],
                  label: 'PPMI category',
                  methodology: 'mip-cde',
          ...
          variables: [
            ...
            },
            {
              ...
              description:
                "There will be two broad categories taken into account. Parkinson''s disease without disability or light disability: Without fluctuation of the effect. Dementia in Parkinson''s disease",
              enumerations: [
                {
                  code: 'PD',
                ...
                },
                {
                  code: 'Other',
                  label:
                    "Parkinson''s disease without disability or light disability: Without fluctuation of the effect"
                }
              ],
      ...
      variables: [
        {
          ...
          label: 'GCS: Best eyes response',
          methodology: 'creactive',
          type: 'polynominal'
        },
        {
          code: 'gcsonadmission_motor',
          enumerations: [
            {
              code: '1',
              label: 'None (1)'
            ...
            {
              code: '3',
              label: 'Flexion (abnormal) to pain (3)'
            },
            {
              code: '4',
              label: 'Withdraws to pain (4)'
            },
            {
              code: '5',
          ...
          label: 'GCS: Best motor response',
          methodology: 'creactive',
          type: 'polynominal'
        },
        {
          code: 'gcsonadmission_verbal',
          enumerations: [
            {
              code: '1',
              label: 'None (1)'
        ...
        },
        {
          ...
          enumerations: [
            ...
            {
              code: 'BiDiallPupil',
              label: 'Bilaterally dilated and non-reactive'
            },
            {
              code: 'UniDiallPupil',
              label: 'Unilaterally dilated and non-reactive'
            },
            {
              code: 'bilalPupil',
              label: 'Reattive bilateralmente e/o miotiche'
            }
          ],
          label: 'Pupils on admission',
          methodology: 'creactive',
          type: 'polynominal'
        },
        {
          code: 'extracranialtrauma',
        ...
        },
        {
          ...
          enumerations: [
            ...
            {
              code: 'Compressed/Distorted',
              label: 'Compressed/Distorted'
            }
          ],
          label: 'Cistern',
          methodology: 'creactive',
          toolTip:
            'Le cisterne perimesencefaliche sono gli spazi liquorali che circondano il mesencefalo.',
          type: 'polynominal'
        },
        {
          code: 'shift',
          ...
          methodology: 'creactive',
          toolTip:
            'Midline shift refers to a the shift of the brain past the imaginary centre line dividing the brain into its two hemispheres.',
          type: 'polynominal'
        },
        {
          code: 'marshall',
          enumerations: [
            {
              code: 'I',
              label: '(D-I) Diffuse injury I'
            },
            {
              code: 'II',
              label: '(D-II) Diffuse injury II'
            },
            {
              code: 'III',
              label: '(D-III) Diffuse injury III'
            },
            {
              code: 'IV',
              label: '(D-IV) Diffuse injury IV'
            },
            {
              code: 'V',
              label: '(5-EML) Evacuated mass lesion'
            },
            {
              code: 'VI',
              label: '(6-NEML) Not Evacuated mass lesion'
            }
          ],
          label: 'Marshall',
          methodology: 'creactive',
        ...
        },
        {
          ...
          label: 'Not Evacuated Hematoma',
          methodology: 'creactive',
          type: 'polynominal'
        },
        {
          code: 'traumaticsubarachnoidhemorr',
          enumerations: [
            {
              code: 'No',
              label: 'No'
          ...
          label: 'Traumatic subarachnoid haemorrhage',
          methodology: 'creactive',
          toolTip:
            'tSAH is blood distributed in the subarachnoid space. Its location can be very limited for example in the interpeduncular space or over the tentorium. Otherwise it can be found in the cortical sulcus or on the brain vault.',
          type: 'polynominal'
        },
        {
          code: 'epiduralhematoma',
          enumerations: [
            {
              code: 'No',
              label: 'No'
          ...
          methodology: 'creactive',
          toolTip:
            'Collection of blood between the dura mater and cranial theca, caused by fractures that can injure the middle meningeal artery or one of its branches. It may be associated with intracranial hypertension and cause coma, usually after a lucid interval. If promptly operated the prognosis is favourable.',
          type: 'polynominal'
        },
        {
          code: 'hypoxia',
        ...
        {
          code: 'glucose',
          label: 'Blood glucose at ER (mg/dl)',
          methodology: 'creactive',
          toolTip: 'The first blood glucose value before ICU admission',
          type: 'real'
        },
        {
          code: 'hb',
          label: 'Hemoglobin ER (gr/dl)',
          methodology: 'creactive',
          toolTip: 'The lowest hemoglobin value available before ICU admission',
          type: 'real'
        },
        {
          code: 'gose',
          enumerations: [
            {
              code: 'ModerateDisabUpper',
              label: 'Moderate disability UPPER LEVEL'
            },
            {
              code: 'ModerateDisabLower',
              label: 'Moderate disability LOWER LEVEL'
            },
            {
              code: 'Vegetative',
            ...
            {
              code: 'GoodRecoveryUpper',
              label: 'Good recovery UPPER LEVEL'
            },
            {
              code: 'SevereDisabLower',
              label: 'Severe disability LOWER LEVEL'
            },
            {
              code: 'GoodRecoveryLower',
              label: 'Good recovery LOWER LEVEL'
            },
            {
              code: 'SevereDisabUpper',
              label: 'Severe disability UPPER LEVEL'
            }
          ],
          label: 'Glasgow Outcome Scale Extended',
          methodology: 'creactive',
          type: 'polynominal'
        },
        {
          code: 'impact_prob_core_mortality',
          label: 'Temporary Impact Probability',
          methodology: 'creactive',
          type: 'real'
        },
        {
          code: 'Mortality',
          label: 'Six Month Mortality',
          methodology: 'creactive',
          sql_type: 'int',
          type: 'integer'
        }
