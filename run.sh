...
if [ $MODE = "local" ]; then
  echo "{\"version\": \"beta 0.0\", \"instanceName\": \"CHUV-DEV\", \"mode\": \"local\", \"theme\": \"mip\"}" > public/config.json
else
  echo "{\"version\": \"beta 0.0\", \"instanceName\": \"CHUV-DEV\", \"mode\": \"federation\", \"theme\": \"mip\"}" > public/config.json
fi
